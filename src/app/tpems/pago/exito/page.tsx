    ...
    <div className="max-w-lg mx-auto px-4 py-12">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-5 mb-6">
        ...
        <ol className="text-sm text-gray-700 space-y-1.5 list-decimal pl-5">
          ...
          <li>Ingresa al portal de alumnos para acceder a tu curso</li>
        </ol>
      </div>
      ...
      <div className="text-center space-y-3">
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          {regId ? (
            ...
            <Link
              href="/tpems"
              className="inline-flex items-center justify-center gap-2 bg-[#0072CE] hover:bg-[#005fa3] text-white font-semibold px-6 py-3 rounded-lg transition"
            >
