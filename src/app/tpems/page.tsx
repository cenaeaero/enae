      ...
      if (!error && data) {
        setRegistrations(
          data.map((r: any) => ({
            ...
            moodle_url: r.courses?.moodle_url || undefined,
            ...
            >
              <div className="flex">
                ...
                <div className="flex-1 p-5">
                  ...
                  {/* Access course button — for confirmed/completed */}
                  {(reg.status === "confirmed" || reg.status === "completed") && reg.moodle_url && (
                    <a
                      href={reg.moodle_url}
                      target="_blank"
                      rel="noopener noreferrer"
                      onClick={(e) => e.stopPropagation()}
                      className="mt-2 mb-3 inline-flex items-center gap-2 bg-[#F57C00] hover:bg-[#E65100] text-white text-sm font-medium px-5 py-2 rounded-lg transition"
                    >
                      Acceder al Curso
