...
type ItemDef = { key: string; label: string; detail?: string; hours: string };
type Phase = { title: string; items: ItemDef[] };
...
type ItemState = { done: boolean | null; hours: string; ops: string };

function emptyItems(): Record<string, ItemState> {
